...
">
    <div class="row ">
      <div class="col-12 col-md-4 border   pt-4">
      ...
      <div class="col-12 col-md-4 border pt-4">
        ...
        <ol>
          <li>☆をボウルに混ぜ合わせておく</li>
          <li>ボウルに★を全て混ぜ合わせておく。</li>
          <li>肉の厚みがある部分を切り開き、厚みを一定にする。鶏肉１枚を２～３等分の大きめに切る。</li>
      ...
      <div class="col-12 col-md-4  pt-4">
          ...
          <h2>コツ・ポイント</h2>
          <p>揚げる際鍋底での焦げ防止に衣が軽く揚がるまで<mark>菜箸等</mark>で時々浮かせて下さい</p>

          <p>好みで粉類に粗びき<ins>黒胡椒小さじ1/2を足しても◎</ins></p>
          <p>にんにくチューブ２センチは<u>ガーリックパウダー小さじ１に変えて粉類と混ぜても美味しいです。</u></p>
          <p>パプリカパウダーは無くても可</p>
      </div>
    </div>
  </div>
